...
#### Série de máximos anuais e índice de referência
...
#### Derivação das curvas de crescimento (*Growth Curves*)
...
#### Construção do Modelo DDF (*Depth-Duration-Frequency*)
...
## AUSTRÁLIA {#sec-australia}

Documento: ***Australian Rainfall and Runoff, 2019*** [@ARR.2019].

### Descrição da Metodologia {#subsec-metodologia_australia}
...
#### Construção de uma base de dados nacional
...
#### Extração das séries de extremos
...
#### Estimativa de L-momentos (média, L-CV, L-assimetria)
...
### Descrição da Metodologia {#subsec-metodologia-canada}
...
#### Downscaling\* espacial e temporal da precipitação
...
### Metodologia do Volume 1 - Estimativas históricas não estacionárias {#subsec-metodologia_eua_vol1}

#### Conjunto de dados relevantes\*\*
...
#### Covariáveis espaciais e temporais
...
### 4.2 Metodologia do Volume 2 - Projeções futuras com modelos climáticos {#subsec-metodologia_eua_vol2}
...
#### Revisão dos fatores de ajuste subdiários
