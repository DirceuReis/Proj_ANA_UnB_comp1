...
Documento: ***Flood Estimation Handbook. Vol 2: Rainfall Frequency estimation [@Faulkner.1999]   ***.
...
Documentos: *Reservoir Safety – Long Return Period Rainfall Volume 1 Technical Report (Part 1 and 2)* [@Stewart.2010a; @Stewart.2010b]
...
O estudo apresenta a metodologia para estimativa das chuvas de projeto na Austrália, no contexto das revisões do *Australian Rainfall and Runoff* [@ARR.2019]. A abordagem adotada baseia-se em um conjunto integrado de etapas, que incluem a criação de uma base de dados nacional de precipitação, o controle de qualidade dos registros, a extração de séries de valores extremos, a análise de frequência, a regionalização e a interpolação espacial.
...
A descrição, aqui inserida, é a mesma encontrada no anexo do artigo de @Simonovic.2016.
