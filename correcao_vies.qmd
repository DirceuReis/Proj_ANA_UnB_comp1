...
O método PresRat estende o QDM incluindo um fator de correção médio [@Lanzante.2021]. Cada valor de $D_f$
calculado a partir de (23) é multiplicado por um fator de correção $K$ específico para o mês do calendário:
