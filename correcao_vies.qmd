...
![Diagrama esquemático do BCQM](figuras/bias.png) Figura 1. (a) mostra o diagrama esquemático para calibração das projetoões do modelo climático: correção de viés; (b) mostra um exemplo da função de densidade de probabilidade (PDF) das variávei envolvidas.
...
<!--Bruno: vale a pena descrever por completo esse método?-->
...
O código R disponibilizado pelos autores do QDM está em: (https://github.com/cran/MBC).
