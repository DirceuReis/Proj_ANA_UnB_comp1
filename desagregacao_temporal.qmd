...
<!-- tomas: essa primeira frase se conecta com alguma anterior? alguma referência? -->

<!-- bruno: concordo com o tomas. Esse primeiro parágrafo está "solto" -->

<!-- bruno: acho que os termos em inglês podem ficar em itálico. Padroniza com os outros textos. -->
...
<!--# tomas: acho que aqui poderia dividir em subtópicos: coefs, isozonas -->
...
<!--# tomas: talvez adotar desde o início a mesma nomenclatura p/ variáveis ex. durações usar $\tau$, $d$, $D$ ou $t$ (acho que pode ser $d$) -->
...
<!--# tomas: padronizar símbolo p/ duração -->
...
<!--# tomas: talvez falar sobre o Atlas Pluviométrico da CPRM aqui -->
...
<!--# tomas: talvez apresentar algumas das figuras de Menaber (1999) fig 4 ou 6, por exemplo -->
...
Borga et al. (2005) aplicam a invariância de escala a séries de máximos anuais de profundidade de chuva em múltiplas durações para derivar uma DDF simples em rede densa nos Alpes italianos. Partem da relação de escala simples em sentido estrito para o máximo anual de duração $D$, $h(D)$:
...
4.  **Técnicas Não Paramétricas / Reamostragem** <!-- bruno: os itens 1. 2. 3. não foram indicados no texto. -->
