...
As relações Intensidade–Duração–Frequência (IDF) são centrais na engenharia de recursos hídricos, pois orientam o dimensionamento seguro e econômico de drenagem, bueiros, pontes e barragens. Em termos simples, uma curva IDF define $(i=f(d,T)$, relacionando a intensidade média máxima $i$, a duração $d$ e a frequência (período de retorno $T$, ou probabilidade anual de excedência). A partir dessas curvas, estimam-se as chuvas de projeto, isto é, eventos de magnitude e raridade específicas que a infraestrutura deve suportar
Van de Vyver, 2018). 
