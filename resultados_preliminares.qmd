...
No total, foram identificados `n_anos_total` anos-estação, dos quais `n_anos_removidos` (`r round(perc_removidos, 1)`%) foram removidos por apresentarem mais de 80% de valores ausentes.
