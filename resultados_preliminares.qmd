...
[1] "0 of 1000 iterations ended with a divergence (0%)"
[1] "0 of 1000 iterations saturated the maximum tree depth of 15 (0%)"
...
## Plotagem dos parametros por intervalo

```{r plot-H-Theta classes}
...
## Plot com parametros geomorfologicos
```{r}
library(sf)
...
stations_Htheta_sf <- stations_Htheta_sf %>%
  st_join(
